...
number_phone = {"Pedro": 11111, "Juan":22222, "Franco":33333, "Luca":44444, "Leo":55555}
...
# names = ("Pedro", "Juan" , "Franco", "Luca", "Leo");
# information = {"Direccion": "Pola 123","Telefono": 1234567890, "Fecha_nac": "20/06/2000"}
# option = input("ingresa tu nombre: ")
# for name in names:
#     if(option == name):
#         print("El producto es: ", name) 
